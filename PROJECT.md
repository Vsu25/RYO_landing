...
- **Estado:** la landing audiovisual V2 fue migrada completamente a Next.js 16, React 19 y TypeScript, con exportación estática para GitHub Pages. Los tres videos propios, el stinger, la anatomía `Playboy → Yuzu → Koga → Sei`, el cierre y el menú local 02-B fueron verificados en React.
- **Objetivo inmediato:** publicar y revisar en GitHub Pages el build Next.js; después se documentará una lista breve de ajustes de polishing. Footer, contacto y publicación del menú permanecen como revisiones separadas.
...
| Landing pública y menú local | [`src/app/page.tsx`](src/app/page.tsx) · [`src/local-pages/MenuPage.tsx`](src/local-pages/MenuPage.tsx) · <https://vsu25.github.io/RYO_landing/> | La landing Next.js se exporta a Pages; el menú React se genera solo en desarrollo local y sigue pendiente de autorización pública. |
...
1. Publicar y revisar con Victor el build Next.js de la secuencia audiovisual V2 en GitHub Pages.
