...
| 28.08.2026 | Adoptar Índice de carta 02-B como sistema del menú funcional: escena encajada con bandas de categoría/plato en escritorio y tarjetas desplegables en tablet/teléfono. | Aprovecha el espacio, mantiene nombre, ingredientes, presentación y precio legibles, y permite ir directamente al plato sin convertir la imagen en un modal dominante. | Aprobada, implementada, verificada y publicada en GitHub Pages |
...
| 30.08.2026 | Escalonar la media, priorizar el LCP, separar CSS por ruta y aislar las escrituras por frame del scroll. | PageSpeed detectó payload, estilos sin uso y trabajo de render prematuro; cada ruta carga solo su sistema visual y el escenario conserva transformaciones compuestas sin rebajar resolución ni simplificar el motion. | Implementado, verificado y cubierto por el despliegue de GitHub Pages |
